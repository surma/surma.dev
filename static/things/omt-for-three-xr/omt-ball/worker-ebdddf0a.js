...
define("./worker-ebdddf0a.js",['./memorypool-ec950d2b'], function (memorypool) { 'use strict';
  ...
  class BallShooter {
    constructor({ numBalls, roomSize, radius, dampening }) {
      ...
      this._radius = radius;
      this._pool = new memorypool.MemoryPool(numBalls * 3 * Float32Array.BYTES_PER_ELEMENT);
      this._ballCounter = 0;
      this.framerate = 90;
    ...
    getPositions() {
      ...
      return memorypool.transfer(buffer, [buffer]);
    }
    ...
    _update() {
      ...
      this._cb(memorypool.transfer(positions, [positions]));
      ///
