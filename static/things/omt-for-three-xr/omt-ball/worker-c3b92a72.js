...
define("./worker-c3b92a72.js",['./comlink-a86b665f'], function (comlink) { 'use strict';
  ...
  class BallShooter {
    constructor({ numBalls, roomSize, radius, dampening }) {
      ...
      this._guns = [
        {
          shooting: false,
          position: new comlink.Vector3(),
          quaternion: new comlink.Quaternion().setFromUnitVectors(new comlink.Vector3(0, 0, 1), new comlink.Vector3(0, 1, 0))
        },
        {
          shooting: false,
          position: new comlink.Vector3(),
      ...
      this._tmpVector = new comlink.Vector3();
