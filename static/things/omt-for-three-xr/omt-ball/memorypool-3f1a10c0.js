define("./memorypool-3f1a10c0.js",['exports'], function (exports) { 'use strict';
    ...
    class MemoryPool {
      ...
      stats() {
        return {
          buffersCreated: this._buffersCreated,
          buffersCached: this._pool.length
        };
      }
