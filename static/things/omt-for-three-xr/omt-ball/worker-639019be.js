...
define("./worker-639019be.js",['./comlink-1af6c585'], function (comlink) { 'use strict';
  ...
  class BallShooter {
    constructor({ numBalls, roomSize, radius, dampening }) {
      ...
      this._radius = radius;
      this._pool = new MemoryPool(numBalls * 4 * 4 * Float32Array.BYTES_PER_ELEMENT);
      this._ballCounter = 0;
      this.framerate = 90;
      ...
      this._guns = [
        {
          ...
          quaternion: new comlink.Quaternion()
        },
        {
          shooting: false,
          position: new comlink.Vector3(),
